...
public class UserController {
    ...
    @PostMapping("/signIn")
    public ResponseEntity<String> signInUser(@Validated @RequestBody UserSignInDTO userSignInDTO) {
       User isSigNiIn = userService.signIn(userSignInDTO);
        if (isSigNiIn != null) {
...
//        System.out.println("received DTO : " + userUpdateDTO.toString());
        String existingUserType = String.valueOf(userService.getTypeOfUser(userId));
